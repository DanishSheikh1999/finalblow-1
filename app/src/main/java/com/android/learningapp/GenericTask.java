...
public class GenericTask extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentPassedVal = intent.getStringExtra("GenericTask");

        Log.d("abc", intentPassedVal);
      //  PhotoView photoView = (PhotoView) findViewById(R.id.Blink);
        ...
        if(intentPassedVal.equals("00"))  //LedBlinking
        progressBar.setMax(8);
        else if(intentPassedVal.equals("01"))//Led fading
        ...
        t5.setText("");}
        else if(intentPassedVal.equals("03"))//Led Mixing
        ...
        else if(intentPassedVal.equals("20"))//Potentiometer serial monitor
        ...
        else if(intentPassedVal.equals("21"))//Potentiometer led
        ...
        else if(intentPassedVal.equals("10"))//Switch serial monitor
        { ques.setText("Arrange the following in correct order");
            o1.setText("}");
            o2.setText("; Serial.begin(9600);");
        ...
        else if(intentPassedVal.equals("11"))//Switch led
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           ...
           if(intentPassedVal.equals("00")) {     //led blinking
...
counter++;
                   ...
                   startActivity(new Intent(GenericTask.this, TabbedActivity.class));
                   finish();
               }
...
//               }
           ...
           else if (intentPassedVal.equals("02")){            //led mixing
...
//               }
               ...
               if (counter == 1) {
                   ...
                   t5.setText("After uploading the code open Serial monitor > set baudrate at 9600 > turn the switch on/off and observe the output");
                   sol.setVisibility(View.GONE);
                   dr.setVisibility(View.GONE);
                   mcq.setVisibility(View.GONE);
                   question.setVisibility(View.GONE);
               ...
               if (counter == 1) {
                   ...
                   startActivity(new Intent(GenericTask.this, UPIPayment.class));
                   finish();
